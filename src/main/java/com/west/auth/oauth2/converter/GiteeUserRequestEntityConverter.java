 ...
 * @date 2021/3/4 10:04
 */
public class GiteeUserRequestEntityConverter implements Converter<OAuth2UserRequest, RequestEntity<?>> {
    @Override
...
//        String openId = (String) userRequest.getAdditionalParameters().get("openid");
        ...
        String userInfoUrl = String.format(OAuth2GiteeContants.GITEE_USER_INFO_URL_FORMAT, uri, accessToken, "zh_CN");
