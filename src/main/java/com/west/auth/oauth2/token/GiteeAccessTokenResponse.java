...
@Setter
@Slf4j
public class GiteeAccessTokenResponse {
    ...
    private GiteeAccessTokenResponse() {

    }

    public static GiteeAccessTokenResponse build(String json) {
        return JSONUtil.toBean(json, GiteeAccessTokenResponse.class);
    }
